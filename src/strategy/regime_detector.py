...
class MarketRegimeDetector:
    ...
    def __init__(self, lookback=30, vol_range_threshold=0.03, vol_trend_threshold=0.08):
        """
        Initialize the market regime detector.
        
        Args:
            lookback (int): Number of days to look back for regime detection
    ...
    def get_recommended_strategies(self, available_strategies):
        ...
        if regime == MarketRegime.RANGING:
            ...
            preferred = ["mean_reversion", "rsi_momentum"]
        elif regime == MarketRegime.TRENDING:
            # For trending markets, prefer trend following strategies
            preferred = ["ema_crossover", "donchian_breakout"]
        else:
            # For normal markets or unknown, use a mix
            preferred = ["ema_crossover", "volume_breakout"]
